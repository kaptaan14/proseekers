      ...
      <div className="flex flex-row gap-3 text-start items-center">
        ...
        <div className="w-full">
          <div className="flex flex-row items-center justify-between w-full">
            ...
            <IoIosArrowForward size={20} className="group-hover:text-blue-200" />
          </div>
          <div>
            <p className="text-gray-200 truncate max-w-[16rem] sm:max-w-[24rem]">Hello Alice! Nice to meet you. How are you?</p>
          </div>
          <div>
