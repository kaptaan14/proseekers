  ...
  return (
    <div className="text-center flex flex-col gap-6">
      <h1 className="text-5xl font-bold leading-snug">
        Create your <span className="text-blue-200">dream project</span> and{" "}
        <br /> find <span className="text-blue-200">like-minded</span>{" "}
        individuals.
      </h1>
      <p className="text-gray-200">
        Collaborate with talented individuals to explore unique opportunities{" "}
        <br />
        and create impactful projects that inspire meaningful growth.
      </p>
      <Link href={'/signup'} >
